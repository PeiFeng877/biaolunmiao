...
## 变更日志
- 2026-03-04: 首登资料完善测试改为覆盖“默认昵称可直接提交、空昵称仍拦截”的新语义，移除头像强制必填断言。
- 2026-03-04: 增加 Debug 强制新用户资料流开关测试，确保老账号回归测试入口可控。
- 2026-03-04: 为首登资料完善新增 ViewModel 校验测试，覆盖“头像 + 昵称”双必填放行条件。
